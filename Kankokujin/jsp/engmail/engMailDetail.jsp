...
<%
	EngmailBean engmailBean = (EngmailBean) request.getAttribute("EngmailBean");
...
<!--
	...
	function deleteCheck(id){
			...
			if(confirm("<fmt:message key="MSG0011" bundle="${message}"/>")){
				location.href = "EngMailDelete?id="+id;
				return true;
			}
	}
	function sendMail(id){
			...
			if(confirm("<fmt:message key="MSG0011" bundle="${message}"/>")){
				location.href = "EngMailSend?mail_id="+id;
				return true;
			}
	}	
...
<table border="0" cellpadding="0" cellspacing="0" width="950"
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="930">
			<!---- Location ---->
			<tr height="30">
				<td align="right"><a href="">Home</a><b>技術者情報詳細画面</b></td>
			</tr>
			<!---- Location ---->
			<tr valign="top">
				<td>
				<table border="0" cellpadding="0" cellspacing="0" width="930"
					height="20">
					<tr>
						<td align="center"><img src="jsp/images/common/title_eng_mail_detail.gif"></td>
					</tr>
				</table>
				</td>
			</tr>
			...
			<tr valign="top" align="center">
				...
				<table width="800" border="1" align="center" cellspacing="0" bordercolor="#E2E0D6">
						<tr>
							...
							<td><%=engmailBean.getSubject()%>
							</td>
							<td>作成者：<%=engmailBean.getUpdate_by_user_id()%>
							</td>
							<td><%=engmailBean.getUpdate_date()%>
							</td>							
						</tr>
						<tr>
							<td>
							...
							<td colspan="3"><%=engmailBean.getTo_mail_list()%>
							</td>
						</tr>						
						<tr>
							<td>
							...
							<td colspan="3"><%=engmailBean.getContents()%>
							</td>
						</tr>
				</table>
				</td>				
			...
			<tr>
				<td>
					...
					<tr style="padding-top:10">
						<td align="right">
						<a href="EngMailList?pageNum=<%=pageBean.getPageNum() %>&pageSize=<%=pageBean.getPageSize() %>">
							<img src="jsp/images/common/btn_list.gif" alt="">
						</a> &nbsp;

						<a href="EngMailUpdateOpen?id=<%=engmailBean.getMail_id()%>"> <img src="jsp/images/common/btn_edit.gif" alt=""></a> &nbsp;
						<img src="jsp/images/common/btn_delete.gif" alt="" onclick='return deleteCheck(<%=engmailBean.getMail_id()%>)'>
						<img src="jsp/images/common/btn_batch_mail_send.gif" alt="" onclick='return sendMail(<%=engmailBean.getMail_id()%>)'>						
