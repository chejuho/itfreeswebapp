...
<c:if test="${RoomSearchBean.cate_code_1 == 'C10001'}">
	<title><c:out value="호텔/민박 수정화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
</c:if>
<c:if test="${RoomSearchBean.cate_code_1 == 'C10002'}">
	<title><c:out value="기숙사/룸메이트 수정화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
</c:if>
...
<!--
	...
	function backDetailPage() {
		document.wf.action="RoomSellDetail";
		document.wf.submit(); 
		return true;
	}	
	function deletePhoto(index) {
		document.wf.action="RoomSellUpdateOpen?del="+index;
		document.wf.submit(); 
		return true;
	}	
	function reloadCheck(){																		
		document.wf.action="RoomSellUpdateOpen";
		document.wf.submit(); 
		return true;
	}	
//-->
	...
	<tr>
		<td height="35">
			...
			<tr><!--이미지수정예정 -->
				<!--호텔/민박-->
				<c:if test="${RoomSearchBean.cate_code_1 == 'C10001'}">
					<td valign="top" width="736" height="82"><img src="jsp/images/new/hotel_edit_title.gif"/></td>
				</c:if>
				<!--기숙사/룸메이트-->
				<c:if test="${RoomSearchBean.cate_code_1 == 'C10002'}">
					<td valign="top" width="736" height="82"><img src="jsp/images/new/roomate_edit_title.gif"/></td>
				</c:if>
			</tr>
			<tr>
				<td valign="top">&nbsp;</td>
						...
						<td bgcolor="#EBF2E6" style="padding:11px 11px 11px 11px;">
							...
							<tr>
								...
								<td width="78%" bgcolor="#FFFFFF" class="table-cont-text">
									...
									<tr>
										<td>
											<select name="area_code_1" id="select4" onchange='return reloadCheck()'>
												${RoomBean.area_1Tag}
											</select>
							...
							<tr>
                  			...
                  			<tr>
                  				<td width="78%" bgcolor="#FFFFFF" class="table-cont-text">
                  					시설비
									<input type="text" name="equipment_fee" id="textfield7" align="absmiddle" style="width:55px;" value="${RoomBean.equipment_fee}" maxlength="6"/>
									&nbsp;엔&nbsp;/보증금
									...
									<tr>
										<td height="30">
											<c:if test="${!empty RoomBean.photo_path1}">
												<img src="${RoomBean.photo_path1}" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
