...
<%
	...
	List eigyouMailList = (List) request
	.getAttribute("eigyouMailList");
...
<!--
	...
	function registOpen(ff) {
		ff.action="EigyouMailRegistOpen";
		ff.submit(); 
		return true;
	}
...
<tr>
	...
	<form name="list" method="post">
		...
		<table width="930" border="0">
			<tr>
				<td align="center"><img src="jsp/images/common/title_eigyou_mail_list.gif"></td>
			</tr>
		</table>
		<table width="930" border="0">
			<tr>
        ...
        <tr valign="top">
          <td>
            ...
            <table border="1" width="930" cellpadding="0" cellspacing="0" bordercolor="#E2E0D6" rules="rows,cols" style="border-collapse:collapse;">
              ...
              <%
                            	Iterator it = eigyouMailList.iterator();
                            	int size = eigyouMailList.size();
                            	if (it.hasNext()) {
                            		while (it.hasNext()) {
                            	EigyoumailBean bean = new EigyoumailBean();
                            	bean = (EigyoumailBean) it.next();
              %>
              <tr height="28">
					<td><%=bean.getMail_id()%></td>
					<td><a href="EigyouMailDetail?id=<%=bean.getMail_id()%>"><%=bean.getTitle()%></a></td>
