	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="930">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="930">
				<!---- Location ---->
				<tr height="30">
					<td align="right"><a href="">Home</a><b>お知らせ</b></td>
				</tr>
				<!---- Location ---->
				<tr>
					<td><!-- QNA -->
					...
					<table width="800" border="0" align="center" cellpadding="0"
						...
						<tr height="28">
							...
							<td><input type="text" name="title" size="40" value="<%=bean.getTitle() %>"
								maxlength="20"></td>
						...
						<tr height="28">
							...
							<td colspan="3"><textarea name="detail_info" rows="6"
								cols="80"><%=bean.getDetail_info() %></textarea></td>
						</tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="680"
						...
						<tr style="padding-top:15">
							...
							<a href="InformUpdateOpen?id=<%=bean.getId()%>">
							<img src="jsp/images/common/btn_cs_rewrite.gif">
							</a>&nbsp; 
							<a href="InformList">
