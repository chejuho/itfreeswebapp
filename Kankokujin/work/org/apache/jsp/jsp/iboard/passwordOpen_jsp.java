...
public final class passwordOpen_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\twindow.alert('メインウィンドウがありません'); // 存在しない場合は警告ダイアログを表示\r\n");
      out.write("\t\t} else{\r\n");
      out.write("\t\t\tvar url = \"\";\r\n");
      out.write("\t\t\tif (ff.sign.value == 'del') {\r\n");
      out.write("\t\t\t\turl=\"IBoardDelete\";\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif (ff.sign.value == 'edit') {\r\n");
      out.write("\t\t\t\turl=\"IBoardUpdateOpen\";\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\twindow.opener.document.wf.pass_word.value = ff.pass_word.value; // 存在する場合はページを切りかえる\r\n");
      out.write("\t\t\twindow.opener.document.wf.id.value = ff.id.value; // 存在する場合はページを切りかえる\r\n");
      out.write("\t\t\twindow.opener.document.wf.action=url;\r\n");
      out.write("\t\t\twindow.opener.document.wf.submit(); \r\n");
      ...
      out.write(" \t\t\t\t<tr>\r\n");
      out.write("   \t\t\t\t\t<td width=\"26%\" height=\"25\" align=\"left\">비밀번호:</td>\r\n");
      out.write("   \t\t\t\t\t<td width=\"43%\">\r\n");
      out.write("   \t\t\t\t\t\t<input type=\"password\" name=\"pass_word\" id=\"textfield2\" class=\"idForm\" />\r\n");
      out.write("   \t\t\t\t\t</td>\r\n");
      out.write("   \t\t\t\t\t<td width=\"31%\">\r\n");
      out.write("   \t\t\t\t\t\t<a href=\"javascript:ok(lf)\" ><img src=\"jsp/images/new/ok_b.gif\" align=\"absmiddle\" height=\"35\" width=\"80\" border=\"0\" tabindex=\"3\"></a>\r\n");
      out.write("   \t\t\t\t\t</td>\r\n");
      out.write(" \t\t\t\t</tr>\r\n");
      out.write("   \t\t\t</table>\r\n");
      out.write("       \t\t</td>\r\n");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sign == 'del'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write(" \t\t\t\t\t게시판내용을 삭제하시려면 비밀번호를 입력해주세요.\r\n");
        out.write(" \t\t\t\t");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sign == 'edit'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write(" \t\t\t\t\t게시판내용을 수정하시려면 비밀번호를 입력해주세요.\r\n");
        out.write(" \t\t\t\t");
