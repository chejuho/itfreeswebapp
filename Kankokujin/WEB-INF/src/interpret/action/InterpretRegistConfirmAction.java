...
public class InterpretRegistConfirmAction extends HttpServlet {
	/**
	 * 
	 */
	...
	private InterpretBean setInterpretBean(InterpretBean bean,
		...
		bean.setService_area_1_name(Util.changeNation(request, service_area_1));
