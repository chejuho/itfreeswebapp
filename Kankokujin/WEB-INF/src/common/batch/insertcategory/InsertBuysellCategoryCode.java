 ...
 * 
 */
public class InsertBuysellCategoryCode{
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertBuysellCategoryCode readExcelData = new InsertBuysellCategoryCode(); 
...
//		}
	...
	public boolean exec() throws Exception {
		...
		FileInputStream fis = new FileInputStream(BatchConstant.BUYSELL_CATEGORY_TABLE_MAKE_FILE);
	...
	public void insertItem(ItemBean itemForm) {
		...
		try {
			...
			pstmt = conn
					.prepareStatement("insert into t_buysell_category " +
