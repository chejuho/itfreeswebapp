 ...
 * 
 */
public class InsertGourmetCategoryCode{
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertGourmetCategoryCode readExcelData = new InsertGourmetCategoryCode(); 
...
//		}
	...
	public boolean exec() throws Exception {
		...
		FileInputStream fis = new FileInputStream(BatchConstant.GOURMET_CATEGORY_TABLE_MAKE_FILE);
