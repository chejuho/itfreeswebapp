 ...
 * 
 */
public class InsertStoreInfo {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertStoreInfo readExcelData = new InsertStoreInfo();
...
//					"/home/hosting_users/kankokujincom/www/store_info.xls");
			FileInputStream fis = new FileInputStream("./excel/store_info.xls");
	 ...
	 * @throws SysException 
	 */
	public void insertItem(ItemBean itemForm) throws SysException {
		...
		try {
			...
			pstmt = conn
					.prepareStatement("insert into store_info (user_id, store_name_k, tel_no1_1, tel_no1_2, tel_no1_3,"
