...
public class StoreRegistHandler {
	/**
	 ...
	 * @throws AppException
	 */
	public boolean insertStoreBean(StoreBean bean) throws SysException {
		Connection con = null;
		LogPreparedStatement pstmt = null;
		try {
			con = DBConnectionMgr.getInstance().getConnection();
			StringBuffer sb = new StringBuffer("insert into store_info (user_id, store_name_k, store_name_j, search_word, tel_no1_1, ");
			...
			KankokujinLogger.getInstance().debug("StoreRegistHandler.insertStoreBean" + pstmt.getQueryString());
			if (result == 1) {
