...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
 <head>
<title><c:out value="업체찾기 등록화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
...
<!--   
	...
	function backSearch() {
		...
		document.wf.action="StoreSearch?f=b";
		document.wf.submit(); 
		return true;
	}	
	function reloadSearch(ff) {
		ff.action="StoreRegistOpen?cate_code_2=-";
		ff.submit(); 
		return true;
	}	
	function deletePhoto(index) {
		document.wf.action="StoreRegistOpen?del="+index;
		document.wf.submit(); 
		return true;
	}	
	function reloadRegist() {
		document.wf.action="StoreRegistOpen";
		document.wf.submit(); 
		return true;
	}
...
<body style="margin:0 0 0 0"> 
	...
	<tr>
		<td height="35">
			...
			<tr>
				<td valign="top" width="736" height="82"><img src="jsp/images/new/store_regist_tit.gif"/></td>
			</tr>
			<tr>
				<td valign="top">&nbsp;</td>
			</tr>
									...
									<tr>
										<td height="30">
											<c:if test="${!empty StoreBean.photo_path1}">
												<img src="<%=storeBean.getPhoto_path1()%>" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
									...
									<tr>
										<td height="30">
											<c:if test="${!empty StoreBean.photo_path2}">
												<img src="<%=storeBean.getPhoto_path2()%>" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
									...
									<tr>
										<td height="30">
											<c:if test="${!empty StoreBean.photo_path3}">
												<img src="<%=storeBean.getPhoto_path3()%>" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
									...
									<tr>
										<td height="30">
											<c:if test="${!empty StoreBean.photo_path4}">
												<img src="<%=storeBean.getPhoto_path4()%>" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
									...
									<tr>
										<td height="30">
											<c:if test="${!empty StoreBean.photo_path5}">
												<img src="<%=storeBean.getPhoto_path5()%>" alt="" align="absmiddle" width="30" height="30">
											</c:if>		
