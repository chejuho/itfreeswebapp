...
<c:if test="${JobBean.cate_code_1 == 'C10100'}">
	<title><c:out value="사원구인 등록화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
</c:if>
<c:if test="${JobBean.cate_code_1 == 'C10200'}">
	<title><c:out value="알바구인 등록화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
</c:if>
...
<!--   
	...
	function reloadSearch(ff) {
		ff.action="JobRegistOpen?cate_code_2=-";
		ff.submit(); 
		return true;
	}	
	function reloadRegist() {
		document.wf.action="JobRegistOpen";
		document.wf.submit(); 
		return true;
	}
	...
	<tr>
		<td height="35">
			...
			<tr><!--이미지수정예정 -->
				<!--사원-->
				<c:if test="${JobBean.cate_code_1 == 'C10100'}">
					<td valign="top" width="736" height="82"><img src="jsp/images/new/reg_title_staff_job.gif" /></td>
				</c:if>
				<!--알바-->
				<c:if test="${JobBean.cate_code_1 == 'C10200'}">
					<td valign="top" width="736" height="82"><img src="jsp/images/new/reg_title_arbeit_job.gif" /></td>
				</c:if>
			</tr>
			<tr>
				<td valign="top">&nbsp;</td>
					...
					<tr>
						<td bgcolor="#EBF2E6" style="padding:11px 11px 11px 11px;">
							...
							<tr>
								...
								<td width="78%" bgcolor="#FFFFFF" class="table-cont-text">
									http://<input type="text" name="url" id="textfield7" class="idForm" align="absmiddle" style="width:240px;" value="${JobBean.url}"/></td>
							</tr>
							<tr>
								<td bgcolor="#f9faf0" class="table-title-text">이메일</td>
								<td width="78%" bgcolor="#FFFFFF" class="table-cont-text">
									<input type="text" name="email" id="textfield8" class="idForm" align="absmiddle" style="width:240px;" value="${JobBean.email}"/></td>
							</tr>
							<tr>
								<td bgcolor="#f9faf0" class="table-title-text"><span class="red-text-w">*</span>전화번호1</td>
								<td width="78%" bgcolor="#FFFFFF" class="table-cont-text">
									<input name="tel_no1_1" type="text" id="textfield9"  class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no1_1}" />-
									<input name="tel_no1_2" type="text" id="textfield10" class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no1_2}" />-
									<input name="tel_no1_3" type="text" id="textfield11" class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no1_3}" /></td>
							</tr>
							<tr>
								<td bgcolor="#f9faf0" class="table-title-text">전화번호2</td>
								<td bgcolor="#FFFFFF" class="table-cont-text">
									<input name="tel_no2_1" type="text" id="textfield12" class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no2_1}" />-
									<input name="tel_no2_2" type="text" id="textfield13" class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no2_2}" />-
									<input name="tel_no2_3" type="text" id="textfield14" class="idForm" maxlength="4" style="width:50px;" value="${JobBean.tel_no2_3}" /></td>
							</tr>
							<tr>
