...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
 <head>
<title><c:out value="음식점 등록화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
...
<!--   
	...
	function registCheck(ff) {
		...
		ff.action="GourmetRegist";
		ff.submit(); 
		return true;
	}			
	
	function reloadSearch(ff) {
		ff.action="GourmetRegistOpen?cate_code_2=-";
		ff.submit(); 
		return true;
	}	
	function reloadRegist() {
		document.wf.action="GourmetRegistOpen";
		document.wf.submit(); 
		return true;
	}
	function deletePhoto(index) {
		document.wf.action="GourmetRegistOpen?del="+index;
		document.wf.submit(); 
		return true;
	}	
	function backSearch() {

		document.wf.action="GourmetSearch?f=b";
		document.wf.submit(); 
		return true;
	}	
//-->
...
<body style="margin:0 0 0 0"> 
	...
	<tr>
		<td height="35">
			...
			<tr><!--이미지수정예정 -->
				<td valign="top" width="736" height="82"><img src="jsp/images/new/gourmet_regist_title.gif" /></td>
			</tr>
			<tr>
				<td valign="top">&nbsp;</td>
			</tr>
