...
<meta http-equiv="Content-type" content="text/html; charset=UTF-8">
 <head>
<title><c:out value="부동산 등록화면"/>&nbsp;::&nbsp;<fmt:message key="TITLE.title" bundle="${message}"/></title>
...
<!--
	...
	function sellcheck(ff) {
		...
		ff.action="HouseSellRegist";
		ff.submit(); 
		return true;
	}		
	function reloadRegist() {
		document.wf.action="HouseSellRegistOpen";
		document.wf.submit(); 
		return true;
	}
	...
	function backSearch() {
		...
		document.wf.action="HouseSellList?f=b";
		document.wf.submit(); 
		return true;
	}	

	function deletePhoto(index) {
		document.wf.action="HouseSellRegistOpen?del="+index;
		document.wf.submit(); 
		return true;
	}	
//-->
...
<body style="margin:0 0 0 0"> 
	...
	<tr>
		<td height="35">
			...
			<tr>
				<td valign="top" width="736" height="82"><img src="jsp/images/new/housesell_regist_title.gif" /></td>
			</tr>
			<tr>
				<td valign="top">&nbsp;</td>
			</tr>
