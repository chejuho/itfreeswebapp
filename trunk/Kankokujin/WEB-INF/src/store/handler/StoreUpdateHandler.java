...
public class StoreUpdateHandler {
	public boolean updateStoreBean(StoreBean bean) throws SysException {
		Connection con = null;
		...
		try {
			...
			sb.append(" set " );
			sb.append(" store_name_k=?, store_name_j=?, work_time=?, search_word=?, tel_no1_1=?, tel_no1_2=?, tel_no1_3=?, tel_no2_1=?, tel_no2_2=?, tel_no2_3=?, " );
			sb.append(" fax_no_1=?, fax_no_2=?, fax_no_3=?, email=?, rest_day=?, url=?, " );
			...
			pstmt.setString(3, bean.getWork_time());
			...
			pstmt.setString(15, bean.getRest_day());	
			pstmt.setString(16, bean.getUrl());
			pstmt.setString(17, bean.getPhoto_name1());
			pstmt.setString(18, bean.getPhoto_name2());
			pstmt.setString(19, bean.getPhoto_name3());
			pstmt.setString(20, bean.getPhoto_name4());
			pstmt.setString(21, bean.getPhoto_name5());
			pstmt.setString(22, bean.getMain_area());
