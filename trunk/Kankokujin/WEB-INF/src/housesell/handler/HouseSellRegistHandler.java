...
public class HouseSellRegistHandler {
	private static HouseSellRegistHandler instance = null;
	private HouseSellRegistHandler(){
		
	}
    public static HouseSellRegistHandler getInstance() {
        if (instance == null) {
            synchronized (HouseSellRegistHandler.class) {
                if (instance == null) {
                    instance = new HouseSellRegistHandler();
                }
            }
        }
	 ...
	 * @throws AppException 
	 */
	 public boolean insertHouseBean(HouseBean bean) throws AppException{
			Connection con= null;
			LogPreparedStatement pstmt = null;
			try{
				con = DBConnectionMgr.getInstance().getConnection();
				StringBuffer sb = new StringBuffer();
				sb.append("insert into house_info(title,house_name,detail_info, manage_fee, house_sort, dimension,");
				sb.append("house_fee,deposit,reikin,walk_time,build_year,madori,all_stairs,stairs,flg_tadami,toilet,line_code,");
				sb.append("station_code,photo_name1,photo_name2,photo_name3,photo_name4,area_code_1,area_code_2,main_area,");
				sb.append("user_id,email,tel_no1_1,tel_no1_2,tel_no1_3,tel_no2_1,tel_no2_2,tel_no2_3,photo_name5,area_fast,area_code_3,point_compass,come_dock,come_dock_year,");
				sb.append("come_dock_month,build_month,guaranty_money,house_option,madori_info,");
				sb.append("update_date,regist_date,read_count)");
				...
				pstmt.setString(18, Util.changeNullCode(1, bean.getStation_code()));
				...
				KankokujinLogger.getInstance().debug("HouseSellRegistHandler.insertHouseBean" + pstmt.getQueryString());
				if(result==1){
					return true;
				}
