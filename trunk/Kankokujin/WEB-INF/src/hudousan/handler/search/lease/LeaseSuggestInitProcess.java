package hudousan.handler.search.lease;
...
public class LeaseSuggestInitProcess extends RequestProcess {
	...
	public String execute(ServletContext context, HttpServletRequest request, HttpServletResponse response) {
		...
		HudousanUtil.initSort(sortBean);
		/** ページ情報 */
		...
		try {
			hudousanBeanList = hudousanSearchHandler.getHudousanBeanListSuggert(pageBean, sortBean, "1");
