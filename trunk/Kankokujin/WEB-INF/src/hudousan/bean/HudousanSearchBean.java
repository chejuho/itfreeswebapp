...
public class HudousanSearchBean extends SearchBean {
	...
	public String getHouse_feeBuy1Tag() {		
		return UtilHandler.getHouse_feeBuy1Tag(house_fee[0]);
	}
	public String getHouse_feeBuy2Tag() {		
		return UtilHandler.getHouse_feeBuy2Tag(house_fee[0], house_fee[1]);
	}
...
/*	public String[] getHouse_option() {
	...
	public void setToilet(String toilet) {
		if("0".equals(toilet)){
			...
			this.toilet_checked[1] = "0";
		} else if ("1".equals(toilet)){
			this.toilet_checked[0] = "0";
