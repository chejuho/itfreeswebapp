 ...
 * 
 */
public class InsertTrainXmlData{
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertTrainXmlData insertAreaXmlData = new InsertTrainXmlData(); 
		try {
			Properties prop1 = insertAreaXmlData.createProperties("Const.LINE_XML");
			Properties prop2 = insertAreaXmlData.createProperties("Const.STATION_XML");
	...
	public void insertItem(ItemBean itemForm) {
		...
		try {
			...
			"(line_code, line_kanji, line_kana, station_code, station_kanji, station_kana)" +		
			"values (?,?,?,?,?,?)");
			pstmt.setString(1, itemForm.getCol01());
			pstmt.setString(2, itemForm.getCol03());
			pstmt.setString(3, "");
			pstmt.setString(4, itemForm.getCol02());
			pstmt.setString(5, itemForm.getCol04());
			pstmt.setString(6, "");
			System.out.println(itemForm.getCol01()+itemForm.getCol03()+itemForm.getCol02()+itemForm.getCol04());
			//pstmt.setString(5, "0");
			pstmt.executeUpdate();
		} catch (Exception e) {
			e.printStackTrace();
