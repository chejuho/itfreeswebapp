 ...
 * 
 */
public class InsertStoreCateXmlData{
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertStoreCateXmlData xmlData = new InsertStoreCateXmlData(); 
		try {
			Properties prop1 = xmlData.createProperties("Const.STORE_CATE_1_XML");
			Properties prop2 = xmlData.createProperties("Const.STORE_CATE_2_XML");
	...
	public void insertItem(ItemBean itemForm) {
		...
		try {
			...
			pstmt = conn
			.prepareStatement("insert into t_store_category " +
