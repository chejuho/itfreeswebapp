 ...
 * 
 */
public class InsertStoreCategoryCode{
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		InsertStoreCategoryCode readExcelData = new InsertStoreCategoryCode(); 
...
//		}
	...
	public boolean exec() throws Exception {
		...
		FileInputStream fis = new FileInputStream(BatchConstant.STORE_CATEGORY_TABLE_MAKE_FILE);
